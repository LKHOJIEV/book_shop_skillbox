    ...
    $(function () {
        ...
        var Card = function () {
            var bookTemplate = function (book) {
                return '<div class="Card">' + '   <div class="Card-picture">' + '<a href="' + book.getBook().getSlug() + '">' + '       <img src="' + book.getBook().getImage() + '">\n' + '</a>' +
                    (book.getBook().getDiscount() ? '<div class="Card-sale">' + parseInt(book.getBook().getDiscount()) + '% скидка</div>' : '') +
                    ((book.getBook().isBestseller > 0) ? '<div class="Card-ribbon"><span class="Card-ribbonText">Бестселлер</span></div>' : '') +
                    ...
                    (book.status === 'KEPT' ? ' <a class="Card-status" title="Отложена"><img src="/assets/img/icons/heart.svg" alt="Отложена"></a>\n' : '') + '    </div>' + '              <div class="Card-content">\n' + '                <strong class="Card-title"><a href="#">' + book.getBook().getTitle() + '</a>\n' + '                </strong>\n' + '             <div class="Card-description">' + book.getAuthors().get(0).getName() + '                </div>\n' + '                <div class="Card-cost">' +
                    (book.getBook().discount_sum() ? '<span class="Card-priceOld">₽' + parseInt(book.getBook().getPrice()) + '</span>\n' : '') + '                       <span class="Card-price">₽' + parseInt(book.getBook().discount_sum()) + '</span>\n' + '                </div>\n' + '              </div>\n' + '            </div>';
            }
            return {
                init: function () {
                    $('[data-refreshshow]').on('click change', function (e) {
                        ...
                        switch (data) {
                            ...
                            case'author':
                                ...
                                break;
                            case'tag':
                                getData('/tag/page/' + $this.data('refreshid'), {
                                    offset: function () {
                                        var oldOffset = $this.data('refreshoffset');
                                        if (oldOffset < 1) {
                                            $this.data('refreshoffset', ++oldOffset);
                ...
                init: function () {
                    ...
                    $btnSend.on('click', function (e) {
                        ...
                        if ($this.data('sendstatus') === 'ARCHIVED' && $this.data('check')) {
                            ...
                            Login().postData('/books/' + $this.data('send') + '/changeBookStatus/' + $this.data('bookid'), {
                                booksIds: $this.data('bookid'),
                                status: status
                            }, function (result) {
                                if (result.result) {
                    ...
                    $ProductAssesment.find('.Rating input').on('change', function (e) {
                        ...
                        Login().postData('/books/' + $this.closest('.Rating').data('send') + '/changeBookStatus/' + $this.closest('.Rating').data('bookid'), {
